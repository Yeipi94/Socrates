...
<asp:content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><small><i class="zmdi zmdi-settings zmdi-hc-fw"></i> MI CUENTA</small></h1>
			</div>
				    			...
				    			<div class="row">
				    				<div class="col-xs-12">
							    		<div class="form-group label-floating">
										  	...
										  	<input  class="form-control" type="text" name="usuario-up" required="" maxlength="15">
										</div>
				    				</div>
